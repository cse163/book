...
So much noise do we need to add to make sure our analysis result respects $\varepsilon$-differential privacy? It turns out that there is a well defined formula for this using a concept called the
...
<Element 'figure' at 0x7fcd23760900>
